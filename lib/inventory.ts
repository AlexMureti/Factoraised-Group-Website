...
export const inventory: Car[] = [
  ...
  },
  {
    ...
    price: 850000,
    location: "Langata, Nairobi",
    images: ["https://www.rushlane.com/wp-content/uploads/2024/09/maruti-fronx-ad-branded.jpg", "https://www.rushlane.com/wp-content/uploads/2024/09/maruti-fronx-ad-branded.jpg"],
  ...
  },
  {
    ...
    price: null,
    location: "Langata, Nairobi",
    images: ["https://www.gari.pk/images/new/cars/2019-01/836_1_72595.jpg", "https://www.gari.pk/images/new/cars/2019-01/836_1_72595.jpg"],
    features: ["Automatic Transmission", "Air Conditioning", "Power Windows", "Central Locking", "CD Player", "ABS"],
    description:
      "Popular Toyota Allion sedan with automatic transmission. Known for reliability and comfort. Perfect for daily commuting.",
    bodyType: "Sedan",
    engineSize: "1500cc",
    color: "Silver",
    condition: "Excellent",
  ...
  },
  {
    ...
    price: 1250000,
    location: "Langata, Nairobi",
    images: ["https://www.autocraftjapan.com/adminPanel/uploads/avis/veh_images/veh_pic_841721371883.jpeg", "https://www.autocraftjapan.com/adminPanel/uploads/avis/veh_images/veh_pic_551721371917.jpeg"],
    features: ["SkyActiv Technology", "Fuel Efficient", "Compact Design", "Bluetooth", "USB Port", "Keyless Entry"],
    description:
      "Stylish Mazda Demio with efficient engine and comfortable interior. Perfect compact car for urban driving and everyday commuting.",
    bodyType: "Hatchback",
